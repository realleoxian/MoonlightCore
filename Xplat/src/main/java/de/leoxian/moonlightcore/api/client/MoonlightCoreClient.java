package de.leoxian.moonlightcore.api.client;

import de.leoxian.moonlightcore.api.client.command.ClientCommandsRegistrar;
import de.leoxian.moonlightcore.api.client.keymapping.KeyMappingRegistrar;
import de.leoxian.moonlightcore.api.client.model.ModelLayerRegistrar;
import de.leoxian.moonlightcore.api.client.model.plugin.ModelLoadPlugin;
import de.leoxian.moonlightcore.api.client.particle.ParticleProviderRegistrar;
import de.leoxian.moonlightcore.api.client.render.BlockEntityRendererRegistrar;
import de.leoxian.moonlightcore.api.client.render.ChunkRenderLayerRegistrar;
import de.leoxian.moonlightcore.api.client.render.EntityRendererRegistrar;
import de.leoxian.moonlightcore.api.client.render.color.BlockColorRegistrar;
import de.leoxian.moonlightcore.api.client.render.color.ItemColorRegistrar;
import de.leoxian.moonlightcore.api.client.runtime.MoonlightCoreClientRuntime;
import de.leoxian.moonlightcore.api.client.runtime.MoonlightCoreClientRuntimeFactory;
